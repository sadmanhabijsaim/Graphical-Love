...
text_obj = ax.text(0, 0, custom_text, color='white',
...
try:
    if writers.is_available('ffmpeg'):
        ...
        ani.save("glowing_heart.mp4", writer=writer)
        print("✅ Animation saved as glowing_heart.mp4")
    else:
        writer = PillowWriter(fps=25)
        ani.save("glowing_heart.gif", writer=writer)
        print("✅ Animation saved as glowing_heart.gif")
